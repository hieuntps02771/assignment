...
if ( ! nv_function_exists( 'nv_news_block_tophits' ) )
{
    ...
    function nv_news_block_tophits ( $block_config, $mod_data )
    {
        ...
        if ( file_exists( NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/news/block_tophitsnews.tpl" ) )
        {
        ...
        $xtpl = new XTemplate( "block_tophitsnews.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/news" );
        $a = 1;
